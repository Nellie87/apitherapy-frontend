// src/app/(dashboard)/expenses/page.styles.ts
...
export const btnGhost =
  "inline-flex items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-2 " +
...
export const tableHead =
  "grid items-center gap-4 text-xs font-semibold uppercase tracking-wider text-slate-500 bg-slate-50 border-b border-slate-200";
